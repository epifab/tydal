...
object PlaceholderExtractor {
  ...
  implicit def nullable[F <: Field[_], X <: HList](implicit placeholderExtractor: PlaceholderExtractor[F, X]): PlaceholderExtractor[Nullable[F, _], X] =
    instance((nullable: Nullable[F, _]) => placeholderExtractor.extract(nullable.field))
